...
/// <summary>
/// Defines a generic CRUD (Create, Read, Update, Delete) service interface for managing entities at the business logic layer.
    ...
    where TEntity : class, IEntity<TId>, new()
{
    ...
    /// </summary>
    /// <param name="ct">A <see cref="CancellationToken"/> to observe while waiting for the task to complete.</param>
    /// <returns>A task whose result is a <see cref="GetAllResult{TEntity}"/> containing the (potentially truncated) item array and true total count.</returns>
    /// <remarks>
    ...
    Task<PagedList<TEntity>> GetPaged(PagedListQuery query, CancellationToken ct = default);
